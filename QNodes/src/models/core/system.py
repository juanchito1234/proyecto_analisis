    ...
    def k_partir(
        ...
        if clave not in self.memo:
            ...
            for cubo in self.ncubos:
                ...
                # Garantía matemática: si un cubo por alguna razón anómala no pertenece a ningún alcance,
                # lo mantenemos intacto para asegurar que |nuevo_sistema.ncubos| == |self.ncubos|
                if not encontrado:
